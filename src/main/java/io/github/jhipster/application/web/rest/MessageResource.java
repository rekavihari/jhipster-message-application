...
public class MessageResource {
     ...
     */
    @GetMapping("/messages")
    public ResponseEntity<List<Message>> getAllMessages(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
